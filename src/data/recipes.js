export const ALL_RECIPES = [
  {
    ...
    steps: [
      ...
      'Pour ¼ cup of batter per pancake. Cook until bubbles form on top, then flip.',
      'Cook the other side for 1-2 minutes until golden. Serve warm.'
    ]
  },
  {
    id: 2,
    ...
    steps: [
      ...
      'Scoop the avocado into a bowl. Add lemon juice, salt and pepper.',
  ...
  },
  {
    ...
    steps: [
      'Heat olive oil in a pan. Sauté onion until soft, then add garlic.',
      ...
      'Serve sauce over spaghetti with parmesan on top.'
    ]
  },
  {
    id: 5,
    ...
    steps: [
      'Marinate chicken in yogurt, garam masala, turmeric and cumin for 30 mins.',
      'Cook chicken in a pan until lightly charred. Set aside.',
      'In the same pan, melt butter and sauté onion until golden.',
      ...
      'Add cream and chicken, simmer for 10 more minutes.',
  ...
  },
  {
    ...
    steps: [
      'Preheat oven to 200°C. Butter and dust ramekins with cocoa powder.',
      'Melt chocolate and butter together in a bowl over hot water.',
      'Whisk eggs, yolks and sugar until pale and slightly thick.',
      'Fold in the chocolate mixture, then sift in the flour and fold gently.',
      'Pour batter into ramekins and bake for 10-12 minutes.',
      'The edges should be set but the center should still wobble.',
